...
class FlutterpluginafnetPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarGlfw *registrar);

  FlutterpluginafnetPlugin();

  virtual ~FlutterpluginafnetPlugin();
...
// static
void FlutterpluginafnetPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarGlfw *registrar) {
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "flutterpluginafnet",
          &flutter::StandardMethodCodec::GetInstance());
  auto plugin = std::make_unique<FlutterpluginafnetPlugin>();
...
FlutterpluginafnetPlugin::FlutterpluginafnetPlugin() {}

FlutterpluginafnetPlugin::~FlutterpluginafnetPlugin() {}

void FlutterpluginafnetPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue> &method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void FlutterpluginafnetPluginRegisterWithRegistrar(
  ...
  FlutterpluginafnetPlugin::RegisterWithRegistrar(insert_result.first->second.get());
}
